var vkccContent = (function () {
	...
	var getChangedValues = function(response){
		//setCss(response.values);
	}
	...
	var setCss = function(values){
		...
		"div.jpv_cont,div#pageHeader,div#sideBar,div#pageBody,div.notifier_baloon_wrap," +
			...
			"#privacy_dropdown," + //http://vk.com/editapp?id=
	...
	return {
		init: function (){
			chrome.runtime.sendMessage({action: "get_values"}, getChangedValues);
